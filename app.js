...
const ordersRoutes = require('./routes/orders'); // Adjust the path as necessary
...
// Middleware
app.use(cors({
  origin: ['http://localhost:3000', 'https://merabestie-delta.vercel.app', 'http://localhost:3000','https://merabestie-orpin.vercel.app','https://merabestie-khaki.vercel.app','https://merabestie.com','https://hosteecommerce.vercel.app'], // Frontend URLs
  credentials: true,
